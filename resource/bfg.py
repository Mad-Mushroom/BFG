    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} BFG strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(GOLDENEYE_BANNER)
    print()
    print(' USAGE: ./bfg.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        bfg = BFG(url)
        bfg.useragents = useragents
        bfg.nr_workers = workers
        bfg.method = method
        bfg.nr_sockets = socks
